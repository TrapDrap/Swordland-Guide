...
- If you are in NEED of personal points, don't be afraid to use an advanced teleporter if you see either 1. any individual with low Town Center level, but high Power Number (meaning lots of troops left) you can go zero them, 2. any structures you scouted that you can certainly beat solo, 3. any crates dropped from structure switch. You will get 2 teleports back from Swordland victory, we expect you to use these for the fight. A strategically well-fought Swordland fight shouldnt cost you less than 5 teleporters even if you are a berserker.
